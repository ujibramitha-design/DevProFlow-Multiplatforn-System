...
export class PhoneFormatter {
     ...
     */
    static addIndonesiaCountryCode(phone) {
     ...
     */
    static removeCountryCode(phone) {
        if (phone.startsWith(this.INDONESIA_COUNTRY_CODE)) {
     ...
     */
    static formatInternational(phone) {
        const cleaned = this.cleanPhoneNumber(phone);
     ...
     */
    static maskPhone(phone, visibleDigits = 4) {
        const formatted = this.formatForDisplay(phone);
...
PhoneFormatter.INDONESIA_COUNTRY_CODE = '62';
PhoneFormatter.WHATSAPP_SUFFIX = '@c.us';
PhoneFormatter.PHONE_PATTERNS = {
